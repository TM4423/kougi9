...
<!-- <header>
  nav class="navbar navbar-default">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="inputdata.php">データ登録</a>
      <a class="navbar-brand" href="logout.php">ログアウト</a> 
      <a class="navbar-brand" href="php_webscr_multi_yahoo.php">yahoo!ニュース</a> 
      <a class="navbar-brand" href="php_webscr_multi_1101.php">ほぼにちニュース</a> 
      </div>
      <div>
        <h1>CodeZineニュース</h1>
        <h3>おすすめ書籍を決める「ITエンジニア本大賞 2022」のベスト10</h3>
      </div>
    </div>
  </nav>
</header> -->
